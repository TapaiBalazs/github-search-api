...
describe('SearchPageComponent', () => {
  ...
  it(`the searchResults are set to an empty array by default`, waitForAsync(() => {
  ...
  it(`'triggerSearch' should call 'search' method in the 'UserSearchService'`, waitForAsync(() => {
  ...
  it(`'triggerSearch' should return the previous cached value if the search request returns an error`, waitForAsync(() => {
  ...
  it(`when a search request takes too long, the user can cancel the request`, waitForAsync(() => {
