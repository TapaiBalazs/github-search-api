...
describe('UserSearchService', () => {
  ...
  it(
    ...
    waitForAsync(() => {
      service.setFilter({} as RawSearchForm);
      ...
      httpMock
        .expectOne({ method: 'GET', url: PAGED_APU_URL }, `${PAGED_APU_URL} should have been called once`)
  ...
  it(
    ...
    waitForAsync(() => {
      ...
      httpMock
        .expectOne({ method: 'GET', url: MOCK_USER_1.url }, `${MOCK_USER_1.url} should have been called once`)
